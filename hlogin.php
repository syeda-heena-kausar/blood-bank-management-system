...
<html>
	...
	<head>
		...
		<title>Login | Hospital Login Form</title>
			...
			<div class="container">
				...
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
						<center> <h5 style="font-family: Noto Sans;">Login to </h5><h4 style="font-family: Noto Sans;">HOSPITAL</h4></center><br>
						<form action="file/hospitalLogin.php" method="post">
							...
							<div class="form-group text-center">
								<br><span class="text-muted">Don't have an account?</span> <a href="hregister.php">Register</a> Here..
							</div>
							<div class="form-group text-center">
